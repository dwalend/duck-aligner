...
// add method put ProposeEvents - reply is server's events to add to the client
// that reply includes a list of events the server wants to know about (is missing due to ec2 reboot)
...
@http(method: "POST", uri: "/proposeNew", code: 200)
